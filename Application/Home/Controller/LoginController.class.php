...

{
	...
	public function upregister($email, $password, $repassword, $verify, $emailcode, $invit){
		...
		$uid =  $rs[] = $mo->table('tw_user')->add(array('username' => $email, 'email'=>$email, 'mobiletime'=>time(), 'password' => md5($password), 'invit' => $tradeno, 'tpwdsetting' => 1, 'invit_1' => $invit_1, 'invit_2' => $invit_2, 'invit_3' => $invit_3, 'addip' => get_client_ip(), 'addr' => get_city_ip(), 'addtime' => time(), 'status' => 1));
